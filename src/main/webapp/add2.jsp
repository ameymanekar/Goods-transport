...
.enjoy-css2 {
  ...
  transform: rotateX(-0.5729577951308232deg) rotateY(0.5729577951308231deg)   ;
   ...
   <body>         
<center>
  <div class="enjoy-css2">  Vehicle Master</div>
<table bstyle="width:100%" cellpadding="25px" cellspacing="25px" >
<form action="add.jsp">
  <tr><td>  <input type="submit"class="enjoy-css" value="Add Vehicle"  /></td>
    
</form>
<form action="delete.jsp">
    <td><input type="submit"class="enjoy-css" value="Vehicle Delete" /></td>
    
</form>
<form action="update.jsp">
    <td><input type="submit"class="enjoy-css" value="Vehicle Update"  /></td></tr>
