...
<div>
  ...
  <a class="navbar-brand" href="">Goods Transport</a>
  <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    <span class="navbar-toggler-icon"></span>
  </button>
        <center>  <div  class="errmsg"><h1 style=" color:white">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <%=loginmsg2%>  <%=loginmsg%></h1>
					</div></center>
				...
				<ul class="rslides" id="slider3">
					<li>
						<div class="slider-img">
							...
							<div class="text">
								  <h3 class="word wisteria">Time_is_money _in_the _shipping _business</h3>
					...
					<li>
						<div class="slider-img-3">
							<div class="slider_banner_info">
								<div class="text">
								  <h3 class="word wisteria">Quality _is_ not_ an_ act,_ it_ is_ a_ habit</h3>
...
<!-- /Footer-->
                        ...
                        <div class="loginf_module">
                            <div class="module form-module">
                                ...
                                <div class="form">
                                    ...
                                    <div class="cta">
                                        <a href="{{ url_for('forgotpass')}}">Forgot password?</a>
                                    </div>
                                </div>
                                <div class="form">
                                    <h3>Create a new account</h3>
                                    <form action="doStoreLogin.jsp" method="post" onsubmit="return myFunction()">
                                        <input type="text" name="name" placeholder="Username" required="">

                                        <input type="password"   id="password" name="pass" placeholder="Password" required="">
                                         <input type="password" id="confirm_password" name="rpass" placeholder="Re Password" required="">
    ...
    font-size: 14px;" placeholder="D.O.B." name="DOB"   required>
                                        <input type="text" pattern="[1,2,3,4,5,6,7,8,9,0]{10}" name="phone" placeholder="Phone Number" maxlength="10" required>
