...
<form action="vadd.jsp" onsubmit="return myFunction()">
					...
					<ul class="field-list">
						<li class="name">
							...
							<div class="form-input">
									...
									<input type="text"  name="name" placeholder="vehicle name" style="text-transform:uppercase" required>
						...
						<li> 
							...
							<div class="form-input">
									...
									<input type="text"  name="vrent" placeholder="Vehicle Rent" required>
