        ...
        <table cellspacing="15px" >
        	...
        	<form action="home2.jsp" target="f2"> 
     		...
     		<form action="add2.jsp" target="f2">
     		 <tr><td class="mbar"> <input type="submit"class="enjoy-css" value="vehicle Master "/></td></tr></form>
        	
        	
        	<form action="ViewEntries.jsp" target="f2">
     		 <tr><td class="mbar"> <input type="submit"class="enjoy-css" value="  View Entries"/></td></tr></form>
        	
        	
        	<form action="ViewBooking.jsp" target="f2">
     		 <tr><td class="mbar"> <input type="submit"class="enjoy-css" value="  View Booking"/></td></tr></form>
